            ...
            <div class="col-md-10"> <!-- list -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="/myba/resources/imgs/ck1.PNG" >
                            <div class="caption">
                                <h4 class="pull-right">1,000\</h4>
                                <h4><a href="#">허쉬 자이언트 초콜렛</a>
                                </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="/myba/resources/imgs/ck2.PNG" >
                            <div class="caption">
                                <h4 class="pull-right">800\</h4>
                                <h4><a href="#">로아커웨하스 미니 3종</a>
                                </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="/myba/resources/imgs/ck3.PNG" >
                            <div class="caption">
                                <h4 class="pull-right">2,300\</h4>
                                <h4><a href="#">하리보 신상품 판타지아</a>
                                </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="/myba/resources/imgs/ck4.PNG" >
                            <div class="caption">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="/myba/resources/imgs/ck5.PNG" >
                            <div class="caption">
                                <h4 class="pull-right">1,100\</h4>
                                <h4><a href="#">피오렐라 초코 비스켓</a>
                                </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="/myba/resources/imgs/ck6.PNG" >
                            <div class="caption">
                                <h4 class="pull-right">2,500\</h4>
                                <h4><a href="#">바이올란타 3종</a>
                                </h4>
