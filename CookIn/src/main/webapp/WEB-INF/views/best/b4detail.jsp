...
<!---------------------------------------------------------------------------------------------------------------->	
    ...
    <div class="col-md-10">
           <div class="row">
            <div class="col-md-7">
                <img class="detailcookies" src="/myba/resources/imgs/ck4.PNG">
            </div>
            <!-- /.col-md-8 -->
            <div class="col-md-5">
                <h2><b>우마이봉 4종</b></h2>
        ...
        <div class="featurette" id="about">
            <img class="featurette-image img-circle img-responsive pull-right" id="curcleb1" src="/myba/resources/imgs/b4d1.PNG">
        ...
        <div class="featurette" id="services">
            <img class="featurette-image img-circle img-responsive pull-left" id="curcleb1"src="/myba/resources/imgs/b4d2.PNG">
        ...
        <div class="featurette" id="contact">
            <img class="featurette-image img-circle img-responsive pull-right" id="curcleb1"src="/myba/resources/imgs/b4d3.PNG">
         ...
         <!-- four Featurette -->
        <div class="featurette" id="services">
            <img class="featurette-image img-circle img-responsive pull-left" id="curcleb1"src="/myba/resources/imgs/b4d4.PNG">
