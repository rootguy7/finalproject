...
<!---------------------------------------------------------------------------------------------------------------->	
    ...
    <div class="col-md-10">
           <div class="row">
            <div class="col-md-7">
                <img class="detailcookies" src="/cook/resources/imgs/ck3.PNG">
            </div>
            <!-- /.col-md-8 -->
            <div class="col-md-5">
        ...
        <div class="featurette" id="about">
            <img class="featurette-image img-circle img-responsive pull-right" id="curcleb1" src="/cook/resources/imgs/b3d1.PNG">
        ...
        <div class="featurette" id="services">
            <img class="featurette-image img-circle img-responsive pull-left" id="curcleb1"src="/cook/resources/imgs/b3d2.PNG">
        ...
        <div class="featurette" id="contact">
            <img class="featurette-image img-circle img-responsive pull-right" id="curcleb1"src="/cook/resources/imgs/b3d3.PNG">
